...
/* harmony import */ var _modules_backup_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/backup.js */ "./www/src/modules/backup.js");
...
{
  _modules_backup_js__WEBPACK_IMPORTED_MODULE_3__["switcher"](action, params);
}

/***/ }),

/***/ "./www/src/modules/backup.js":
/*!***********************************!*\
  !*** ./www/src/modules/backup.js ***!
  \***********************************/
...
function switcher(action, params)
{
  switch(action)
  {
    case 'backupAll':
...
function Backup() {
  ...
  _modal_js__WEBPACK_IMPORTED_MODULE_0__["alertBox"]('info', "Sauvegarde en cours", "INFO", 50000);

  $.post("/ajax/index.php", data, function (data) {
    _modal_js__WEBPACK_IMPORTED_MODULE_0__["alertBox"]('success', "Sauvegarde terminée", "SUCCESS", 50000);
...
/*!**********************************!*\
  !*** ./www/src/modules/modal.js ***!
  \**********************************/
/*! exports provided: createModal, addButtons, alertBox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function editUser(id)
{
  ...
  _modal_js__WEBPACK_IMPORTED_MODULE_0__["createModal"]("user-manage", "user-edit", "Edition utilisateur","modal-lg");
...
function authenticate() {
  ...
  if (login == "" || passw == "") {
    _modal_js__WEBPACK_IMPORTED_MODULE_0__["alertBox"]('danger', 'Vous devez saisir un login et un mot de passe !', 'ERREUR');
    return false;
  }
  ...
  $.post("/ajax/index.php", data,function (resp) {
      if (resp.Errno == -1) {
        _modal_js__WEBPACK_IMPORTED_MODULE_0__["alertBox"]("danger",resp.ErrMsg,'ERREUR');
        return false;
      }
...
function changePass() {
  ...
  if( $('#pass1').val() != $('#pass2').val() ){
    ...
    _modal_js__WEBPACK_IMPORTED_MODULE_0__["alertBox"]('danger', Msg, 'ERREUR', 20000);
    return false;
  }
  ...
  if (score > 80) {
    ...
    _modal_js__WEBPACK_IMPORTED_MODULE_0__["alertBox"]('info', Msg, 'Information', 2000);
  }
  if (score < 30){
  ...
  $.post("/ajax/index.php", data, function (resp) {
    if (resp.Errno != 0) {
      ...
      _modal_js__WEBPACK_IMPORTED_MODULE_0__["alertBox"]('success', resp.ErrMsg, 'INFO');
    }
  });
}
