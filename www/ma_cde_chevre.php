...
//la table "amap_chevre_cde_en_cours" doit être créée en dupliquant le contenu de la table "amap_chevre_cde"
...
//fin mise à jour table_cde_en_cours
			...
			//il faut trouver une date de livraison telle que aujourd'hui < à cette date - JOURS_MARGE_CHEVRE jours
      ...
      $result=mysqli_query("SELECT Unite FROM amap_chevre_produits ORDER BY Id") or die(mysqli_error());;
      ...
      for( $i=0; $i <$nbProduit; $i++) {
		...
		<div id="page_principale">
			...
			<table 	style="
				...
				>
				<?php
	   			echo 'Commande de fromages de chèvre pour la livraison du '.$ProchLiv;
				?></caption>
					<tr>
        ...
        // itération sur les produits  : l'ordre des champs de la table amap_chevre_cde doit correspondre à 
        // l'ordre définit par le champ Id de la table amap_chevre_produit
...
<!-- xml:lang : sert à indiquer dans quelle langue est rédigée votre page -->
	...
	<body onload="document.getElementById('motpasse').focus();">
		...
		<div id="page_principale">
			...
			?>
			<h3 class="mot_passe_recette">Vous n'êtes pas inscrit à l'AMAP fromage de chèvre</h3>
		</div>		
		<div id="pied_page">
			<!-- <?php include_once("includes/pied_page.php") ?> -->
		</div>
