...
<!-- xml:lang : sert Ã  indiquer dans quelle langue est rÃ©digÃ©e votre page -->
	...
	<body onload="document.getElementById('motpasse').focus();">
		...
		<div id="page_principale">
			...
			?>
			  <h3 class="mot_passe_recette">Vous êtes inscrit sur la liste d&apos;attente Légumes
			  <a href="liste_attente_legumes.php"> (cliquer ici pour consulter la liste d&apos;attente)</a> </h3>
		</div>		
		<div id="pied_page">
