...
<!-- xml:lang : sert à indiquer dans quelle langue est rédigée votre page -->
    ...
    <tr>
       <td align="center">
            <img style="display: inline; " title="les vergers du moulin" src="images/moulinnoues.jpg" alt="" width="160" />
            <img style="display: inline; " title="les vergers du moulin" src="images/moulinnoues5.jpg" alt="" width="160" />
            <img style="display: inline; " title="les vergers du moulin" src="images/moulinnoues2.jpg" alt="" width="160"  />
       </td>
       <td>
...
<h1 class="texte">Le cycle annuel se découpe en 4 phases </h1> 
 ...
 <p class="texte" >Davril à juillet : prévention et suivi technique du verger (champignon, insectes, éclaircissage des pommes, attachage des pommiers, réparation de poteaux, fil de fer ...), cueillette des cerises...    </p>
      ...
      <td align="center">
          ...
          <img style="display: inline;" title="le moulin" src="images/moulinnoues1.jpg" alt="" width="180" height="240" />
      </td>
      </tr>
      <tr>
        <td align="center">
             <img style="display: inline; " title="les vergers" src="images/moulinnoues7.jpg" alt="" width="160" height="120" />
        </td>
        <td>
 ...
 <p class="texte" ><strong class="texte">Cerises</strong> : Elle nous propose 4 cueillettes à l'exploitation au mois de juin.  </p>
        ...
        <tr>
          <td align="center" colspan="3">  
            <img  title="les vergers du moulin" src="images/moulinnoues3.jpg" alt=""  />
          </td>
        </tr>
    </table>
